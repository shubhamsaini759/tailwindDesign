...
const Skeleton = () => {
  return (
    <>
        ...
        <div role="status" class="space-y-8 mt-5 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center">
        ...
        <div role="status" class="max-w-sm p-4 mt-5 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
